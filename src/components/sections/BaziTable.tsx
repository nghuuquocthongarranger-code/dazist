                      ...
                      {tsData?.list.map((sao, i) => {
                        ...
                        return (
                          <button
                            ...
                            className={`block w-full text-left text-[10px] sm:text-xs leading-relaxed hover:underline ${color}`}
                          >
                            {sao}
                          </button>
                        );
...
function BodySection() {
  return (
    <Section title="Thân Vượng — Dụng / Hỷ / Kỵ Thần" eyebrow="Cốt lõi lá số">
...
function ElementsSection() {
  return (
    <Section title="Tỉ lệ Ngũ Hành & Thập Thần" eyebrow="Ngũ Hành">
...
function FamilySection() {
  return (
    <Section title="Gia đình & Hôn nhân" eyebrow="Lục thân · Lương duyên">
...
function HealthSection() {
  return (
    <Section title="Sức khỏe" eyebrow="Cơ thể">
...
function WealthCareerSection() {
  return (
    <Section title="Tài lộc & Sự nghiệp" eyebrow="Tiền bạc · Con đường">
      <div className="space-y-3">
        <div>
...
function SummarySection() {
  return (
    <Section title="Tổng kết lá số" eyebrow="Luận chung">
