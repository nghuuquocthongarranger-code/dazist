    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="glass glass-gold-edge relative rounded-3xl p-6 sm:p-8 max-w-2xl w-full max-h-[85vh] overflow-y-auto"
        >
          <button
            type="button"
            onClick={onClose}
            aria-label="Đóng"
            className="absolute top-4 right-4 min-w-[44px] min-h-[44px] grid place-items-center rounded-full border border-white/15 text-white/60 hover:text-gold-soft hover:border-gold/50 transition"
          >
            ✕
          </button>
